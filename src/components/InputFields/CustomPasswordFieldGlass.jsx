...
CustomPasswordFieldGlass.propTypes = {
  ...
  dataCyInput: PropTypes.string.isRequired,
  dataCyLabel: PropTypes.string.isRequired,
  dataCyError: PropTypes.string.isRequired,

      ...
      <div data-auto={`field-container-${dataAuto}`} className={`relative`}>
        <input
          ...
          className={`focus:outline-primary cursor-pointer bg-base-300  input w-full rounded-md input-bordered ${
            visibleBorder
              ? `disabled:border-none disabled:text-black px-3`
              : ` ${disable ? "px-1" : "px-3"}`
          }  ${fieldClassName}
        `}
        />
      ...
      >
            ...
            <button
              ...
              className={`${
                selectedAmOrPm === "AM"
                  ...
                  : "border-gray-300"
              } cursor-default w-full px-3 rounded-md py-2 border-2`}
            >
              AM
            </button>
            <button
        ...
        {!!(
          ...
          <div
            ...
            className={`text-xs text-red-500 flex justify-center items-center mt-1 gap-x-1`}
          >
            {minTime && maxTime && (
              <>

  ...
  return (
    <div data-auto={`container-${dataAuto}`} className="w-full relative">
          ...
          >
            ...
            {!disable && (
              <button
                ...
                onClick={() => {
                  console.warn({ line: new Error().lineNumber });
                  onSelect(
      ...
      <OutsideClickHandler
        ...
        dataAuto={`${dataAuto}-option_container`}
      >
        <div className={` font-medium shadow-md w-full `}>
          ...
          <label
            htmlFor={"custom-multi-select-select-all-input-all-page"}
            ...
            {!!selectAllOption && (
              <div className=" flex items-center gap-2">
                <input
                  ...
                  id="custom-multi-select-select-all-input-all-page"
                  name=""
                  onChange={(e) => {
                    if (e.target.checked) {
